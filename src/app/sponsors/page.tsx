...
export default function SponsorsPage(){return <main id="main">
  <section className="editorial-hero"><p className="eyebrow">01 / PARTNERSHIP</p><Reveal><h1>BUILD THE<br/><span className="text-primary">NEXT TEAM.</span></h1><p>Help RobotECS give students the tools, materials, and real engineering experience required to build toward FIRST Robotics Competition.</p><Button asChild variant="link" className="mt-7 h-auto p-0 text-white underline decoration-primary underline-offset-8"><Link href="/packages">Explore sponsorship packages <ArrowUpRight/></Link></Button></Reveal></section>
